...
Deployment dilakukan menggunakan Streamlit Community Cloud melalui file utama app.py. Aplikasi menggunakan data sample dari folder data_sample, sehingga tidak perlu memuat dataset asli yang berukuran besar.
